...
export const Sidebar = () => {
  ...
  const switchTab = useCallback((tab) => {
    ...
    if (tab === 'calendar') {
      ...
      setCurrentView('canvas'); // Switch to Canvas View
      ...
      <div className="p-4 pb-2">
        ...
        <div className="flex p-1 bg-black/40 rounded-lg border border-white/5 mb-4" role="tablist">
          ...
          <button 
            ...
            title="Canvas"
          >
            <Layout size={12} className="mx-auto"/>
          </button>
        </div>
      </div>
                ...
                >
                  <div className="flex items-center gap-2 truncate flex-1">
                    ...
                    {editingSessionId === session.id ? (
                      <div className="flex items-center gap-1 flex-1">
                        ...
                        />
                        <button onClick={submitRename} className="text-green-500 hover:text-green-400">
                          <Check size={10}/>
                        </button>
                      </div>
                    ) : (
                  ...
                  {editingSessionId !== session.id && (
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={(e) => startRenaming(e, session)} className="hover:text-white p-1">
                        <Edit2 size={10} />
                      </button>
                      <button onClick={(e) => handleDeleteSession(e, session.id)} className="hover:text-red-400 p-1">
                        <Trash2 size={10} />
                      </button>
                    </div>
                  )}
            ...
            {!isCreatingProj ? (
              ...
              <div className="mb-3 p-2 bg-[#111] rounded-lg border border-white/10 animate-fade-in">
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <button onClick={handleCreateProject} className={`text-[9px] px-2 py-0.5 rounded text-white ${theme.primaryBg} disabled:opacity-50`}>Create</button>
                </div>
              </div>
            )}
              ...
              {projects.map(proj => (
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={(e) => openProjectSettings(e, proj)} className="text-gray-500 hover:text-white p-1">
                        <Sliders size={10} />
                      </button>
                      <button onClick={(e) => handleDeleteProject(e, proj.id)} className="text-gray-500 hover:text-red-400 p-1">
                        <Trash2 size={10} />
                      </button>
                    </div>
                  </div>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={closeProjectSettings} className="text-gray-500 hover:text-white transition-colors"><X size={14} /></button>
              </div>
              <textarea 
